import shauny from "../static/shauny3.jpeg";
...
const people = [
  ...
  },
  {
    ...
    xUrl: "",
    linkedinUrl: "https://www.linkedin.com/in/beckycurry/",
  },
];
      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 gap-x-8 gap-y-20 px-6 lg:px-8 xl:grid-cols-3 ">
        <div className="mx-auto max-w-2xl ">
          ...
          <p className="mt-6 text-lg leading-8 text-neutral-600">
            Loamy was founded after Shauny had a frustrating experience as
            a fertility patient, which led her to pivot her last health tech
            company. The company was further inspired by Rebecca's own frustration navigating 
            the healthcare and integrative care systems as a 2x child cancer survivor. 
          </p>
          <p className="mt-6 text-lg leading-8 text-neutral-600">
